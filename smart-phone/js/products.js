...
// إذا كانت الصفحة الحالية هي صفحة التصنيف، قم بتهيئتها
if (window.location.pathname.includes('category.html')) {
    document.addEventListener('DOMContentLoaded', loadCategoryPage);
}

// إذا كانت الصفحة الحالية هي صفحة العلامة التجارية، قم بتهيئتها
if (window.location.pathname.includes('brand.html')) {
    document.addEventListener('DOMContentLoaded', loadBrandPage);
}

// إذا كانت الصفحة الحالية هي صفحة البحث، قم بتهيئتها
